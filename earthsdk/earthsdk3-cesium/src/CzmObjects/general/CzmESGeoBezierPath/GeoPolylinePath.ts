...
import { Destroyable, Listener, Event, react, bind, track, reactPositions, reactArray, extendClassProps, ReactivePropsToNativePropsAndChanged, createNextAnimateFrameEvent, SceneObjectKey } from "xbsj-base";

export class GeoPolylinePath extends Destroyable {
    private _geoPath;
...
export namespace GeoPolylinePath {
...
extendClassProps(GeoPolylinePath.prototype, GeoPolylinePath.createDefaultProps);
