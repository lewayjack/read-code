...
const GeometryInstanceAttribute = Cesium.GeometryInstanceAttribute;
...
let PolylineShadowVolumeFS = Cesium._shadersPolylineShadowVolumeFS; // vtxf
const PolylineShadowVolumeMorphFS = Cesium._shadersPolylineShadowVolumeMorphFS; // vtxf
const PolylineShadowVolumeMorphVS = Cesium._shadersPolylineShadowVolumeMorphVS; // vtxf
let PolylineShadowVolumeVS = Cesium._shadersPolylineShadowVolumeVS; // vtxf
...
PolylineShadowVolumeVS = PolylineShadowVolumeVS.replace('width = width * max(0.0, czm_metersPerPixel(positionEC));', '');
PolylineShadowVolumeFS = PolylineShadowVolumeFS.replace('float halfMaxWidth = v_startPlaneNormalEcAndHalfWidth.w * czm_metersPerPixel(eyeCoordinate);', 'float halfMaxWidth = v_startPlaneNormalEcAndHalfWidth.w;');
