...
import { AroundPolyline } from "./AroundPolyline";
import { TopPolyline } from "./TopPolyline";
import { ESCesiumViewer } from "../../../../ESCesiumViewer";
import { flyTo } from "../../../../utils";

export class DepthPolygon extends Destroyable {
    ...
    constructor(sceneObject: CzmPolygonWithHeight, czmViewer: ESCesiumViewer) {
        ...
        this._innerPolygon = this.disposeVar(new InnerPolygon(sceneObject, czmViewer, true, polygonGround));
        this._bottomPolyline = this.disposeVar(new BottomPolyline(sceneObject, czmViewer, polygonGround));
        this.disposeVar(new AroundPolyline(sceneObject, czmViewer));
        this.disposeVar(new TopPolyline(sceneObject, czmViewer));
